jQuery("#simulation")
  .on("click", ".s-67bce125-f80c-47be-a197-76bd17222114 .click", function(event, data) {
  ...
  .on("variablechange.jim", ".s-67bce125-f80c-47be-a197-76bd17222114 .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
